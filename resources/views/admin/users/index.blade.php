        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-white p-4 rounded-lg shadow">
                    ...
                    <div class="text-2xl font-bold text-gray-900">{{ $userCounts['total'] }}</div>
                </div>
                <div class="bg-white p-4 rounded-lg shadow">
                    <div class="text-sm text-gray-500">Doctors</div>
                    <div class="text-2xl font-bold text-blue-600">{{ $userCounts['doctors'] }}</div>
                </div>
                <div class="bg-white p-4 rounded-lg shadow">
                    <div class="text-sm text-gray-500">Pharmacists</div>
                    <div class="text-2xl font-bold text-green-600">{{ $userCounts['pharmacists'] }}</div>
                </div>
                <div class="bg-white p-4 rounded-lg shadow">
                    <div class="text-sm text-gray-500">Admins</div>
                    <div class="text-2xl font-bold text-purple-600">{{ $userCounts['admins'] }}</div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="search" value="{{ $search }}" placeholder="Name, email, or phone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                <a href="{{ route('admin.users.edit', $user->id) }}" class="text-green-600 hover:text-green-900" title="Edit">
                                                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
